...
<div class="box-body">		
  ...
  <label for="categorias" class="col-md-4 control-label"> Selecciona la categoria</label>
    <div class="row">
      <div class="form-group form-group-options col-md-4 col-md-offset-5">
          <select data-live-search="true" data-width="auto" class="selectpicker dropup show-tick"  name="categoria" id="categoria" title="" required> 
   ...
   <div class="form-group">
  <label for="variables" class="col-md-4 control-label"> Selecciona la variable</label>
    <div class="row">
      <div class="form-group form-group-options col-md-4 col-md-offset-5">
          <select data-live-search="true" data-width="auto" class="selectpicker dropup show-tick"  name="variable" id="variable" title="" required> 
   ...
   <div class="form-group">
  <label for="ambitos" class="col-md-4 control-label"> Selecciona el ámbito</label>
    <div class="row">
      <div class="form-group form-group-options col-md-4 col-md-offset-5">
          <select data-live-search="true" data-width="auto" class="selectpicker dropup show-tick"  name="ambito" id="ambito" title="" required> 
