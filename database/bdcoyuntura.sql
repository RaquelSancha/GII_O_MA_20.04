...
-- Creación de nuevas tablas datosine y urldatosine 
--
-- Table structure for table `datosine`
--

CREATE TABLE `datosine` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `datosine`
--

INSERT INTO `datosine` (`id`, `nombre`, `periodo`, `año`, `valor`, `idUrl`, `idVariable`, `idCategoria`, `idAmbito`) VALUES
(8, 'Total Nacional. Mujeres. De 25 a 29 años. Personas. ', 'T1', 2019, 1247.7, 3, 5, 90, 10),
(8, 'Total Nacional. Mujeres. De 25 a 29 años. Personas. ', 'T1', 2020, 1253.4, 3, 5, 90, 10),
(8, 'Total Nacional. Mujeres. De 25 a 29 años. Personas. ', 'T2', 2020, 1251.6, 3, 5, 90, 10);
...
--
-- Indexes for table `datosine`
--
ALTER TABLE `datosine`
  ADD PRIMARY KEY (`id`,`nombre`,`periodo`,`año`);
...
--
-- AUTO_INCREMENT for table `datosine`
--
ALTER TABLE `datosine`
...
--
-- Table structure for table `urldatosine`
--

CREATE TABLE `urldatosine` (
  `id` int(11) NOT NULL,
  `url` varchar(400) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `urldatosine`
--

INSERT INTO `urldatosine` (`id`, `url`) VALUES
(2, 'https://servicios.ine.es/wstempus/js/ES/DATOS_TABLA/22344'),
(3, 'https://servicios.ine.es/wstempus/js/ES/DATOS_TABLA/4028');
...
--
-- Indexes for table `urldatosine`
--
ALTER TABLE `urldatosine`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `urldatosine`
--
ALTER TABLE `urldatosine`
